//! Fullscreen kiosk demo
//!
//! Same content as `demo.rs`, but runs fullscreen on the primary monitor —
//! the WilhelmOS kiosk-mode validation app. All positions are derived from
//! the actual window dimensions instead of being hardcoded.
